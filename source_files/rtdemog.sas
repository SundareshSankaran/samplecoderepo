...
data final;
  ...
  if order>3 then page=2;
run;

%mtitle(progid=&progid, type=rtf);
...
proc report data=final headline headskip nowindows split='|' missing spacing=1;
  ...
  define trt1 / "     0 - 2 |     (N=&pop1)" style={cellwidth=11%};
  define trt2 / "     3 - 6 |     (N=&pop2)" style={cellwidth=11%};
  define trt3 / "     7 - 11 |     (N=&pop3)" style={cellwidth=11%};
  define trt4 / "     12 - &up_limit |     (N=&pop4)" style={cellwidth=11%};
  define trt5 / "     3 - &up_limit   Total |     (N=&pop5)" style={cellwidth=11%};
  define trt6 / "     Total |     (N=&pop6)" style={cellwidth=11%};
